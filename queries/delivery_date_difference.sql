...
-- Consulta para calcular la diferencia de entrega por estado
SELECT 
    c.customer_state AS Estado,
    ROUND(AVG(julianday(o.order_delivered_customer_date) - julianday(o.order_estimated_delivery_date)), 2) AS Diferencia_Entrega
FROM 
    olist_orders o
JOIN 
